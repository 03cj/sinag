...
const DashboardA = () => {
  ...
  const handleStatusChange = (studentNo, newStatus, remark = null) => {
    ...
    if (newStatus === 'Approved') {
      ...
      alert(
        `Status for Intern ${studentNo} updated to ${newStatus}. ${remark ? `Remark: ${remark}` : ''} (mock action).`,
      );
    }
  };
  ...
  const handleGenerateEndorsementLetter = ({ intern, companyDetails, hrDetails }) => {
    ...
    alert(
      `Endorsement letter for ${intern.firstname} ${intern.lastname} generated for ${companyDetails.companyName} with HR ${hrDetails.hrName}!`,
    );
        ...
        const mockInterns = [
          {
            ...
            firstname: 'Juan',
            mi: 'S.',
            goodMoral: '/docs/juan_good_moral.pdf',
            cor: '/docs/juan_cor.pdf',
            medicalClearance: '/docs/juan_medical.pdf',
            insurance: '/docs/juan_insurance.pdf',
            resume: '/docs/juan_resume.pdf',
            status: 'Pending',
            remarks: null,
          },
          {
            ...
            firstname: 'Maria',
            mi: 'L.',
            goodMoral: '/docs/maria_good_moral.pdf',
            cor: '/docs/maria_cor.pdf',
            medicalClearance: '/docs/maria_medical.pdf',
            insurance: '/docs/maria_insurance.pdf',
            resume: '/docs/maria_resume.pdf',
            status: 'Approved',
            remarks: null,
          },
          {
            ...
            firstname: 'Pedro',
            mi: 'A.',
            goodMoral: '/docs/pedro_good_moral.pdf',
            cor: '/docs/pedro_cor.pdf',
            medicalClearance: '/docs/pedro_medical.pdf',
            insurance: '/docs/pedro_insurance.pdf',
            resume: '/docs/pedro_resume.pdf',
            status: 'Pending',
            remarks: null,
          },
          {
            ...
            firstname: 'Chen',
            mi: 'P.',
            goodMoral: '/docs/chen_good_moral.pdf',
            cor: '/docs/chen_cor.pdf',
            medicalClearance: '/docs/chen_medical.pdf',
            insurance: '/docs/chen_insurance.pdf',
            resume: '/docs/chen_resume.pdf',
            status: 'Disapproved',
            remarks: 'Missing signature on COR.',
          },
          {
            studNo: '115',
            lastname: 'Tan',
            firstname: 'Kevin',
            mi: 'C.',
            goodMoral: '/docs/kevin_good_moral.pdf',
            cor: '/docs/kevin_cor.pdf',
            medicalClearance: '/docs/kevin_medical.pdf',
            insurance: '/docs/kevin_insurance.pdf',
            resume: '/docs/kevin_resume.pdf',
            status: 'Pending',
            remarks: null,
          },
        ];
    ...
    <div className="p-5 md:p-8 bg-gray-100 min-h-screen">
        ...
        <table className="min-w-full divide-y divide-gray-300">
          <thead className="bg-red-800">
            <tr>
              <th
                scope="col"
                className="px-6 py-3 text-left text-xs font-bold text-white uppercase tracking-wider rounded-tl-lg"
              >
                Stud. no.
              </th>
              ...
              <th
                scope="col"
                className="px-6 py-3 text-left text-xs font-bold text-white uppercase tracking-wider rounded-tr-lg"
              >
                Status
              </th>
            </tr>
      ...
      {showAddInternForm && (
        <div className="fixed inset-0 bg-red-400/20 backdrop-blur-md flex items-center justify-center z-50">
          <AddIntern onAddSucess={handleAddNewIntern} onCancel={() => setShowAddInternForm(false)} />
        </div>
      )}
    </div>
  );
