...
const CompaniesC = () => {
      ...
      try {
        const mockCompanies = [
          ...
          },
          {
            ...
            email: 'contact@xyz.net',
            supervisor: 'Ms. Johnson',
            address: '456 Min. Ave.',
            moa: 'xyz_agreement.pdf',
          ...
          },
          {
            no: '004',
            name: 'Global Tech',
            email: 'support@globaltech.org',
            supervisor: 'Dr. Lee',
            address: '789 Lopez Ln.',
            moa: 'global_tech_moa.pdf',
          ...
          },
          {
            ...
            supervisor: 'Mr. Davis',
            address: '101 Que. St.',
            moa: 'creative_moa.pdf',
            natureOfBusiness: 'Creative Agency',
            MOAStart: '2022-09-01',
            MOAEnd: '2024-09-01',
          },
        ];
...

  {
    ...
    const handleEditMoa = () => {
      console.log('Update MOA button clicked!');
    };
    ...
    const handleConfirmDelete = () => {
      if (companyToDelete) {
        setCompanies((prev) => prev.filter((c) => c.no !== companyToDelete.no));
      }
            ...
            <div className="fixed inset-0 bg-red-400/20 backdrop-blur-md flex items-center justify-center z-50">
              <UpdateMoa
                ...
                onUpdateSuccess={(updatedCompany) => {
                  setCompanies((prev) => prev.map((c) => (c.no === updatedCompany.no ? updatedCompany : c)));
