...
const ProfileI = () => {
  ...
  const ReadOnlyField = ({ label, value }) => (
    <div className="flex items-center">
      ...
      <div className="mt-1 block w-2/3 px-3 py-2 bg-gray-100 border border-gray-300 rounded-md">
        {value}
      </div>
    </div>
  );
    ...
    <div className="flex justify-center items-start min-h-screen bg-gray-100 p-8">
      ...
      >
        ...
        <form onSubmit={handleCombinedSave} className="p-6">
          ...
          {/* Certification */}
          <div
            className={`p-4 border-l-4 ${BORDER_COLOR} bg-gray-50 text-gray-600 italic text-sm mb-6`}
          >
