    ...
    documents: [
      {
        ...
        uploaded: false,
        file: null,
        remarks: 'Please ensure the certificate is signed by a licensed physician.',
      },
      {
        name: 'Resume / CV',
        uploaded: true,
        file: 'resume_cv.pdf',
        remarks: 'Your OJT Coordinator approved your resume.',
      },
      {
        name: 'Insurance',
        uploaded: false,
        file: null,
        remarks: 'Kindly upload your insurance policy before the internship start date.',
      },
      ...
      return (
        <div>
          ...
          <div className="flex items-center space-x-2">
            <span
              className={`px-3 py-1 text-sm font-semibold text-white rounded-full ${getStatusColor(internData.status)}`}
            >
              {internData.status}
            </span>
          ...
          <div className="space-y-4">
            <div className="bg-gray-100 p-4 rounded-lg border border-gray-300">
              ...
              <p className="text-sm text-gray-600">
                Please review your resume and update it with your latest projects. This message was sent on July 15,
                2025.
              </p>
            </div>
            <div className="bg-gray-100 p-4 rounded-lg border border-gray-300">
              ...
              <p className="text-sm text-gray-600">
                Your internship has been approved. Please check the 'Documents' section to see what's next. This message
                was sent on July 10, 2025.
              </p>
            </div>
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="bg-red-800 text-white p-6 rounded-lg shadow-md">
        <h2 className="text-3xl font-bold">Welcome Intern!</h2>
        <h3 className="text-xl font-semibold italic text-white mb-4 whitespace-nowrap">
          {' '}
          Surname, Fname, Midd name(2022-902048)
        </h3>
      </div>
      ...
      <div className="flex flex-col md:flex-row md:space-x-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border border-gray-300">
            ...
            <div className="grid grid-cols-1 gap-4 text-gray-700">
              ...
              <div className="col-span-1">
                <p>
                  <span className="font-medium">Hours Required:</span> {internData.companyDetails.hoursRequired} hrs
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md border border-gray-300 flex-1">{renderRightBoxContent()}</div>
      </div>
    </div>
  );
};
